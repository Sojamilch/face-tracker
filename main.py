...
argParser.add_argument("-y", "--height", type=int,
                       default=720, help="Camera viewport height in pixels")
argParser.add_argument("-x", "--width", type=int, default=1280,
                       help="Camera viewport width in pixels")
argParser.add_argument("-fs", "--frameskips", type=int, default=4,
                       help="Ammount of frames to skip, larger number reduces cpu usage")
